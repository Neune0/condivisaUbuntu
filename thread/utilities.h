...
#define TEMPO_SPAWN_COCCODRILLI 10// tempo di spawn dei coccodrilli
...
// - x : coordinata x
// - y : coordinata y
// - on_coccodrillo : bool TRUE se Rana è su coccodrillo
// - id_coccodrillo : id del coccodrillo su cui sta la Rana
// - offset_on_coccodrillo : offset tra la sprite del coccodrillo e quella della Rana
typedef struct{
	int x;
	int y;
	bool on_coccodrillo;
