...
#define PIANTA_H 3 // altezza della pianta
...
#define MAXNNEMICI 3
#define MAXNPROIETTILINEMICI 3
#define MAXNTANE 5
#define MAXNSPRITES 9
...
// elenco: S_RANA, S_PROIETTILE, S_TANA_APERTA, S_TANA_CHIUSA
typedef enum{
	S_RANA, 
	S_PROIETTILE, 
	S_TANA_APERTA, 
...
typedef struct{
	...
	Sprite sprites[MAXNSPRITES]; // le sprite degli oggetti
	...
	AllTCB allTCB; // array di TCB di tutti i threads
}GameData;
 ...
 * @param semafori: Struttura da cui recupera i semafori
...
/** @brief dato un array di tcb individua una posizione vuota ed utile
 * @param array_pid : l'array di tcb da analizzare
 * @param lunghezza : la lunghezza dell'array tcbs
*/
 ...
 * @param dati_vecchi : posizione al passo precedente
 * @param dati_nuovi : posizione attuale
*/
...
/**	@brief Restituisce il thread_id 
 * @param thread_tcb: TCB del thread che voglio leggere
 * @param semaforo:: semaforo per sincronizzazione
 * @return il thread_id del thread
*/
